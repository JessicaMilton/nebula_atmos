...
//
// WARNING!!
// ALWAYS DYNAMICALLY IMPORT THIS FILE
//
//////////////////////////////////////////////////////////////////////////
...
export const fhevmMockCreateInstance = async (parameters: {
  ...
  // Query EIP712 domain from InputVerifier to get verifyingContract and chainId
  ...
  const instance = await MockFhevmInstance.create(
    ...
    provider,
    {
      ...
      verifyingContractAddressDecryption: parameters.metadata.KMSVerifierAddress, // placeholder; not used by mock verify
