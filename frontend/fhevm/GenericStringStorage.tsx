...
class GenericStringInMemoryStorageImpl implements GenericStringStorage {
...
export const InMemoryStorageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const [storage] = useState<GenericStringStorage>(new GenericStringInMemoryStorageImpl());
